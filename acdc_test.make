...
RD = results/acdc_geo_final/rep$(REP)
# CFLAGS = -O
# DEBUG = --debug
...
TRNFOLD = ce_rloss ce ce_weak ce_bl_geo_point_fast ce_bl_int_point_fast ce_bl_mbd_point ce_bl_eucl_point_fast 
...
$(RD)/%: data/ACDC-2D-GEO/test/img data/ACDC-2D-GEO/test/gt
	...
	$(CC) $(CFLAGS) inference.py --data_folder=$(<) --batch_size=$(BS) \
		--num_classes=4 --group $(DEBUG) --grp_regex="$(G_RGX)" \
